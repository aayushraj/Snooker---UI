...
A comprehensive full-stack management system for snooker clubs built with **Next.js 14**, **React 18**, **shadcn/ui**, **Electron**, and **C# .NET 8** with **SQLite**.
...
```plaintext file="app/backend/SnookerClubApi.csproj"
